    ...
    <div class="container forn-dlt">
      <div class="row g-3 align-items-center">
        ...
        <div class="col-auto col-lg-8">
          <input type="text" id="inputPassord6" name="coursename" value="${course.coursename}" class="form-control" aria-describedby="passwordHelpInline">
        </div>
      </div>
      ...
      <div class="row g-3 align-items-center">
        ...
        <div class="col-auto col-lg-8">
          <input type="text" id="inputPassword6" name="duration" value="${course.duration}" class="form-control" aria-describedby="passwordHelpInline">
        </div>
      </div>
      ...
      <div class="row g-3 align-items-center">
        ...
        <div class="col-auto col-lg-8">
          <select class="form-select" aria-label="Default select example" name="category">
            ...
            <option value="1"
            <c:if test="${course.category=='1'}">selected</c:if>
            >
            One
            </option>
            <option value="2"
            <c:if test="${course.category=='2'}">selected</c:if>
            >Two</option>
            <option value="3"
            <c:if test="${course.category=='3'}">selected</c:if>
            >Three</option>
          </select>
        </div>
      </div>
      ...
      <div class="row g-3 align-items-center">
        ...
        <div class="col-auto col-lg-8">
          <input type="text" id="inputPassword6" name="fees" value="${course.fees}" class="form-control" aria-describedby="passwordHelpInline">
        </div>
      </div>
